...
userController.updateById = async (req, res, next) => {
  ...
  try {
    ...
    twilio.lookups.v1
      ...
      //console.log('updatedUser after Twilio call: ', updatedUser);
      ...
      console.log('ERROR. Twilio phone lookup: ', err);
      next(err);
    });
...
userController.updateSettings = async (req, res, next) => {
  ...
  try {
    ...
    twilio.lookups.v1
      ...
      console.log('ERROR. Twilio phone lookup in updateSettings: ', err);
      next(err);
    });
